      ...
      while(runAgain == 1)
      {
	      ...
	      // Output
	         ...
	         {   
	            ...
	            {
	               System.out.println("\nCourse(s) Placed Into: ENG-071 + RDG-071\n");
	            ...
	            if (essayScore == 3)
	            {
	               ...
	               {
	                  System.out.println("\nCourse(s) Placed Into: ENG-072 + RDG-072\n");
	                  System.out.println("Up to two (2) college courses from the following list:");
	               ...
	               if (essayScore == 4) // ENG-073 + ENG-101 ALP
	               {
	                  if (NGR >= 247)
	                  {
	                     System.out.println("\nCourse(s) Placed Into: ENG-073-ALP + ENG-101-ALP\n");
	                  ...
	                  if (essayScore == 5)
	                  {
	                     ...
	                     {
	                        System.out.println("\nCourse(s) Placed Into: ENG-096 + ENG-101 or ENG-101-AL\n");
	                     }
	                     else if (NGR <= 254)
	                     {
	                        System.out.println("\nCourse(s) Placed Into: ENG-073-ALP + ENG-101-ALP\n");
